  ...
  return (
    <main>
      <div className="mx-auto max-w-6xl px-4 py-32 sm:px-6">
        ...
        <p className="mt-6 font-mono text-sm uppercase tracking-[0.25em] text-amber-400">
          {mod.preHeader}
        </p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a
            href="#contact"
            className="inline-flex items-center rounded-xl border border-white/15 bg-white/5 px-4 py-2.5 font-sans text-sm font-semibold text-zinc-100 transition hover:border-amber-400/40"
          >
            ...
            <ul className="mt-4 space-y-3 font-sans text-sm text-zinc-300">
              {mod.highlights.map((h) => (
                <li key={h} className="flex gap-3">
                  <span
                    className="mt-1 h-2 w-2 shrink-0 rounded-full bg-amber-400/80 shadow-[0_0_12px_rgba(251,191,36,0.5)]"
                    aria-hidden
                  />
                  <span>{h}</span>
                </li>
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 py-32 sm:px-6 lg:grid-cols-2 lg:items-center">
          <div
            className="aspect-[4/3] overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-amber-500/15 via-amber-900/20 to-transparent"
            aria-hidden
          />
          <div>
            <p className="font-mono text-sm uppercase tracking-[0.25em] text-amber-400">
